...
- **Index Page**: In `index.html` user not only see the listing names of all pages in the encyclopedia but can click on any entry name also to be taken directly to that entry page.
